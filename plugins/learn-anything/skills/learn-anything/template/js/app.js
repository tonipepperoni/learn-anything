...
(function () {
  ...
  var THEMES = [
    ...
    { id: 'tokyonight',       name: 'Tokyo Night',      sw: ['#9ece6a', '#7aa2f7', '#f7768e', '#1a1b26'] },
    { id: 'catppuccin-mocha', name: 'Catppuccin Mocha', sw: ['#a6e3a1', '#89b4fa', '#f38ba8', '#1e1e2e'] },
    { id: 'gruvbox',          name: 'Gruvbox',          sw: ['#b8bb26', '#83a598', '#fb4934', '#282828'] },
    { id: 'everforest',       name: 'Everforest',       sw: ['#a7c080', '#7fbbb3', '#e67e80', '#2d353b'] },
    { id: 'rose-pine',        name: 'Rosé Pine',        sw: ['#9ccfd8', '#3e8fb0', '#eb6f92', '#191724'] },
    { id: 'onedark',          name: 'One Dark',         sw: ['#98c379', '#61afef', '#e06c75', '#282c34'] },
    { id: 'kanagawa',         name: 'Kanagawa',         sw: ['#98bb6c', '#7e9cd8', '#e46876', '#1f1f28'] },
    { id: 'catppuccin-latte', name: 'Catppuccin Latte', sw: ['#40a02b', '#1e66f5', '#ea76cb', '#eff1f5'] },
